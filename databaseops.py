...
def insert_habit(app, hab):
    conn = app.connection
    c = app.connection.cursor()
    with conn:
        c.execute("INSERT INTO habitlist(category, name, count, start_date) VALUES (:category, :name, :count, :start_date)",
