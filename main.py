...
class SpartanGrid(GridLayout):
    ...
    def click_me(self, instance):
        ...
        self.didIt = Button(text = "Did it!", on_press = self.count_up, background_color = [169/255,255/255,221/255,1], size_hint = (.5, .25) )
        self.didnt = Button(text = "Not today", on_press = self.count_down, background_color = [253/255, 129/255, 129/255, 1], size_hint = (.5, .25) )
        #print(self.habit1cnt.text)
        self.add_widget(self.habit1)
        self.add_widget(self.habit1cnt)
